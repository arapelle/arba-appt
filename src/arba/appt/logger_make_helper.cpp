...
spdlog::sink_ptr logger_make_helper::make_console_sink_mt(std::string_view log_pattern)
{
...
spdlog::sink_ptr logger_make_helper::make_console_sink_st(std::string_view log_pattern)
{

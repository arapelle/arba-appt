...
TEST(basic_application_tests, test_constructor_empty)
{
    arba::appt::basic_application<> app;
    ASSERT_TRUE(app.args().empty());
}

TEST(basic_application_tests, test_constructor)
{
    appt::basic_application<> app(core::program_args(pargc, pargv));

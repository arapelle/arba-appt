...
TEST(exception_handling_with_spdlog_tests, test_main_module_run_fails__init_not_called_logging)
{
    using app_type = ut_application<multi_task_logging_application>;
...
TEST(exception_handling_with_spdlog_tests, test_main_module_init_fails__bad_derived_module)
{
    using app_type = ut_application<multi_task_logging_application>;
